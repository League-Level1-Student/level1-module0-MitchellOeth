...
int score = 0;
		...
		for (int i = 0; i < 4; i++) {
			...
			if (i==0) {
			if (guess.equals("Ronald Reagan")) {
				JOptionPane.showMessageDialog(null, "Correct!");
				score+=1;	
			}
			else {
			JOptionPane.showMessageDialog(null, "Incorrect! The correct answer was Ronald Reagan");	
			}
			}
			if (i==1) {
				if (guess.equals("Leonardo Decaprio")) {
					JOptionPane.showMessageDialog(null, "Correct!");
					score+=1;	
				}
				else {
				JOptionPane.showMessageDialog(null, "Incorrect! The correct answer was Leonardo Decaprio");	
				}
				}
			if (i==2) {
				...
				JOptionPane.showMessageDialog(null, "Incorrect! The correct answer was Morgan Freeman");	
				}
				}
			if (i==3) {
				...
				JOptionPane.showMessageDialog(null, "Incorrect! The correct answer was Jack Black");	
				}
				}
